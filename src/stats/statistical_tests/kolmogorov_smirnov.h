...
#ifndef THIRD_PARTY_HYBRID_RCC_SRC_STATS_STATISTICAL_TESTS_KOLMOGOROV_SMIRNOV_H_
#define THIRD_PARTY_HYBRID_RCC_SRC_STATS_STATISTICAL_TESTS_KOLMOGOROV_SMIRNOV_H_
...
#endif  // THIRD_PARTY_HYBRID_RCC_SRC_STATS_STATISTICAL_TESTS_KOLMOGOROV_SMIRNOV_H_
