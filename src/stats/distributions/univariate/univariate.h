...
#ifndef THIRD_PARTY_HYBRID_RCC_SRC_STATS_DISTRIBUTIONS_UNIVARIATE_UNIVARIATE_H_
#define THIRD_PARTY_HYBRID_RCC_SRC_STATS_DISTRIBUTIONS_UNIVARIATE_UNIVARIATE_H_
...
#endif  // THIRD_PARTY_HYBRID_RCC_SRC_STATS_DISTRIBUTIONS_UNIVARIATE_UNIVARIATE_H_
