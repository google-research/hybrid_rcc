...
#ifndef THIRD_PARTY_HYBRID_RCC_SRC_STATS_DISTRIBUTIONS_MULTIVARIATE_CONTINUOUS_TRUNCATED_GAUSSIAN_H_
#define THIRD_PARTY_HYBRID_RCC_SRC_STATS_DISTRIBUTIONS_MULTIVARIATE_CONTINUOUS_TRUNCATED_GAUSSIAN_H_
...
#endif  // THIRD_PARTY_HYBRID_RCC_SRC_STATS_DISTRIBUTIONS_MULTIVARIATE_CONTINUOUS_TRUNCATED_GAUSSIAN_H_
