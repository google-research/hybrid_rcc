...
#ifndef THIRD_PARTY_HYBRID_RCC_STATS_RANDOM_NUMBER_GENERATOR_STL_URBG_H_
#define THIRD_PARTY_HYBRID_RCC_STATS_RANDOM_NUMBER_GENERATOR_STL_URBG_H_
...
#endif  // THIRD_PARTY_HYBRID_RCC_STATS_RANDOM_NUMBER_GENERATOR_STL_URBG_H_
